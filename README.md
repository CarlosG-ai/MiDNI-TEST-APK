...
El proyecto implementa tests unitarios y CI para compilar en debug usando automatizaciones en GitHub Actions, además del análisis de seguridad de GitHub CodeQL configurado en el repositorio.
...
Workflow incluido en el repositorio:
